...
namespace ClientUpdater
{
    ...
    {
        private string PatchHost = "http://20.226.67.109/upd1";
        private string WebHost = "http://20.226.67.109/painel";
        public string Patch = "Patch.ini";
        public string currentDirectory = Directory.GetCurrentDirectory();
        public string mainFile = Directory.GetCurrentDirectory() + Path.DirectorySeparatorChar + "system/l2.exe";
        public string updatesDirectory = Directory.GetCurrentDirectory() + Path.DirectorySeparatorChar + "temp";
        ...
        private void Updater_Load(object sender, EventArgs e)
        {
            if (IsAlreadyRunning())
            {
                MessageBox.Show("Updater já esta aberto", "Updater Lineage2Shield", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Environment.Exit(0);
            }
        }
        ...
        private void updaterWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            while (fileProcessQueue.Count > 0)
            {
                ...
                Invoke((MethodInvoker)delegate
                {
                    SpeedLable.Text = "";
                    percentLable.Text = "";
                    StatusLable.Text = "Checando " + totalFilesProcessed + "/" + totalFilesToBeProcessed + " Arquivos...";
                });
        ...
        {
            Process.Start(WebHost + "/index.php?icp=panel&show=register");
        }

        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(WebHost + "/forum");
        }
        ...
        {
            Process.Start(WebHost + "/index.php?icp=panel&show=recovery");
        }
        ...
        private void clearDirectory(string path)
        {
            ...
            {
                _ = MessageBox.Show(ex.Message, "Updater Lineage2Shield", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void OnDownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            CurrentProgBar.Width = Convert.ToInt32(Math.Round(e.ProgressPercentage / 100.0 * 446.0));
        ...
        private void startGameBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Executável do Lineage não encontrado, favor realizar novo fullcheck.", "Updater Lineage2Shield", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void OnIniDownloadCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            {
                EnableStartGameButton();
                StatusLable.Text = "Checagem de arquivos encerrado manualmente";
            }
            else if (e.Error != null)
            {
                EnableStartGameButton();
        ...
        private void OnVersionDownloadCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            {
                EnableStartGameButton();
                StatusLable.Text = "Verificação da versão parada manualmente";
            }
            else if (e.Error != null)
            {
                EnableStartGameButton();
        ...
        private void BulkFileProcess()
        {
            ...
            StatusLable.Text = "Total " + totalFilesToBeProcessed + " arquivos processados";
            DisableFullCheckButton();
            DisableStartGameButton();
            EnableStopButton();
            if (!updaterWorker.IsBusy)
